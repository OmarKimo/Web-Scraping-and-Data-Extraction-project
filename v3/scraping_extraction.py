...
def request(checkedItems, in_date_range_from, in_date_range_to, optionsDict, window):
    window.submit["state"] = "disabled"
    window.county["state"] = "disabled"
    window.date_range_from["state"] = "disabled"
    window.date_range_to["state"] = "disabled"
    data = []
    ...
    window.date_range_from["state"] = "normal"
    window.date_range_to["state"] = "normal"
    window.submit["state"] = "normal"
    window.county["state"] = "readonly"
